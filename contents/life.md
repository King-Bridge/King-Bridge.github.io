...
Besides my passion for robotics, I am deeply devoted to music and sports. They are the sources of my energy and creativity.
...
<div style="display: flex; align-items: center; background-color: #f8f9fa; border: 1px solid #eee; border-left: 4px solid #4CAF50; padding: 15px; margin-top: 20px; border-radius: 8px; gap: 15px; flex-wrap: wrap;">
  
  <div style="flex-shrink: 0; width: 120px; height: 120px; border-radius: 6px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <img src="../static/assets/img/soccer_cover.jpg" alt="WeChat Article Cover" style="width: 100%; height: 100%; object-fit: cover; display: block;">
  </div>

  <div style="flex: 1; min-width: 200px;">
    <strong style="font-size: 16px; color: #333; display: block; margin-bottom: 8px;">📰 Featured Article</strong>
